...
export default function CompanionsStories() {
    ...
    const debouncedFetch = _.debounce((searchValue) => {
        dispatch(
            fetchSearchResult({ path: "/sahabaaStories/search", searchWord: searchValue })
        );
    }, 300);
    ...
    useEffect(() => {
        dispatch(fetchData(`sahabaaStories/?limit=${loadLimit}&page=${currentPage}`));
    }, [dispatch, currentPage]);
    return (
        <>
            <NewNavbar />
            <FixedHeader subtitle={"Companions Stories"} />
                    ...
                    <div className="lg:col-span-9 col-span-12 h-fit">
                        ...
                        <div>
                            ...
                            {!searchValue &&
                                ...
                                AllTawheed?.sahabaaStories?.length > 0 && (
                                    <div>
                                        {AllTawheed?.sahabaaStories.map((hadith) => (
                                            <HadithComponent
                                                key={hadith._id}
                                                hadithNumber={hadith.hID}
                    ...
                    <div className="lg:col-span-3 col-span-12 py-[10px]">
                        ...
                        <div className="text-center py-4">
                            ...
                            <p className="font-english leading-relaxed  font-medium text-[16px] text-[#5f6068]">
                                We study the stories of the Sahaba to learn from their faith, character, and dedication to Islam. Their lives are examples of sacrifice, courage, and sincerity in following the Prophet ﷺ. Through their stories, we are inspired to stay firm in our faith, strive in good deeds, and live with strong morals, just as they did in serving Allah and His Messenger.
                            </p>
                        </div>
