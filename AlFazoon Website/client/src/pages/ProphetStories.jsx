...
export default function ProphetStories() {
    ...
    const debouncedFetch = _.debounce((searchValue) => {
        dispatch(
            fetchSearchResult({ path: "/anbiaaStories/search", searchWord: searchValue })
        );
    }, 300);
    ...
    useEffect(() => {
        dispatch(fetchData(`anbiaaStories/?limit=${loadLimit}&page=${currentPage}`));
    }, [dispatch, currentPage]);
    return (
        <>
            <NewNavbar />
            <FixedHeader subtitle={"Prophet Stories"} />
                    ...
                    <div className="lg:col-span-9 col-span-12 h-fit">
                        ...
                        <div>
                            ...
                            {!searchValue &&
                                ...
                                AllTawheed?.anbiaaStories?.length > 0 && (
                                    <div>
                                        {AllTawheed?.anbiaaStories.map((hadith) => (
                                            <HadithComponent
                                                key={hadith._id}
                                                hadithNumber={hadith.hID}
                    ...
                    <div className="lg:col-span-3 col-span-12 py-[10px]">
                        ...
                        <div className="text-center py-4">
                            ...
                            <p className="font-english leading-relaxed  font-medium text-[16px] text-[#5f6068]">
                                We study the stories of the Prophets to strengthen our faith and learn valuable lessons from their lives. Each Prophet was chosen by Allah to guide people with truth, patience, and wisdom. Through their stories, we learn about trust in Allah, perseverance in hardship, and the importance of spreading goodness. They remind us how to remain steadfast and devoted to Allah in every situation.
                            </p>
                        </div>
